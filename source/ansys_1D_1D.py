...
class AnsysCommands1D1D(AnsysCommands):
    ...
    def create_variable_file(self):
        ...
        data.write_text('elem_per_line =' + str(100))
        ...
        data.write_text('G10_element_diameter =' + str(self.calculate_insulation_diameter_1d_1d()))
    ...
    def calculate_insulation_diameter_1d_1d(self):
        ...
        G10_element_area = volume_per_G10_element/G10_element_length
        G10_element_diameter = (4*G10_element_area/math.pi)**(0.5) / 1000.0                               # [m]
        print("G10_element_diameter_equals = {} [m])".format(G10_element_diameter))
        return G10_element_diameter
