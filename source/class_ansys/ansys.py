...
from source.class_ansys.ansys_table import Table
...
import source.class_geometry.geometry as geometry
import time

class AnsysCommands(SkewQuadrupole):
    ...
    def set_analysis_setting(self):
        ...
        print(self.mapdl.executeCommandToString('deltim,100.0e-6,100.0e-6,1000.0e-6'))

    # postprocessor commands6
