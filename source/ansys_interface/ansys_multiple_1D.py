...
from source.ansys_interface.ansys_thermal_network import AnsysThermalNetwork

class AnsysMultiple1D(AnsysThermalNetwork):
    ...
    def create_insulation_material_properties(self, class_mat):
        """
    ...
    def upload_apdl_solver_input_file(self):
        """
