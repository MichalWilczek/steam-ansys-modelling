...
# set ground
ans.set_ground_for_multiple_dimensions(class_geometry=coil_geo)

# input solver ANSYS APDL file
ans.input_solver_file_for_multiple_dimensions()

# get temperature profile
temperature_profile = ans.get_temperature_profile_for_multiple_dimensions(npoints=npoints, class_geometry=coil_geo)
