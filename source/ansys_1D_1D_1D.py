...
class AnsysCommands1D1D1D(AnsysCommands):
    ...
    def create_variable_file(self):
        ...
        data.write_text('G10_element_area =' + str(self.calculate_insulation_diameter_1d_1d_1d()))
    ...
    def calculate_insulation_diameter_1d_1d_1d(self):
        if self.factory.get_number_of_windings() != 1:
            ...
            G10_volume_per_winding = (
                                                 winding_area - strand_area) * self.factory.get_length_per_winding() * 1000.0  # [mm3]
