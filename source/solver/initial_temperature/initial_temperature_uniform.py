...
class InitialTemperatureUniform(InitialTemperature):
    ...
    def set_initial_temperature(self):
        ...
        temperature_profile = self.create_private_temperature_profile(
            node_down=ic_zone_node_min, node_up=ic_zone_node_max,
            temperature_constant=self.factory.temperature_max_init_quenched_zone)

        self.calculate_energy_initially_deposited_inside_the_coil(
            node_down=ic_zone_node_min, node_up=ic_zone_node_max,
            magnetic_field_value=self.factory.constant_magnetic_field_value, temperature_init_distr=temperature_profile)
