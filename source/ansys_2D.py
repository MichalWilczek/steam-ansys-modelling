...
class AnsysCommands2D(AnsysCommands):
    ...
    def create_variable_file(self):
        ...
        data.write_text('quench_init_pos =' + str(self.factory.get_quench_init_pos()))
        data.write_text('quench_init_length =' + str(self.factory.get_quench_init_length()))
        data.write_text('winding_plane_max_number_nodes =' + str(self.factory.get_winding_plane_max_number_nodes()))
        ...
        data.write_text('transverse_division_winding =' + str(self.factory.get_transverse_division_winding()))
