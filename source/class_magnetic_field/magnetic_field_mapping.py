...
from source.data_skew_quadrupole import SkewQuadrupole


class MagneticMap(SkewQuadrupole):
    ...
    def winding_y_pos_list():
        ...
        """
        init_pos_x = MagneticMap.WINDING_SIDE / 2.0
        number_turns_in_layer = MagneticMap.NUMBER_TURNS_IN_LAYER
        array = np.arange(init_pos_x, MagneticMap.WINDING_SIDE*number_turns_in_layer+init_pos_x,
                          MagneticMap.WINDING_SIDE)
        return array
    ...
    def winding_x_pos_list():
        ...
        array = np.arange(init_pos_x, MagneticMap.WINDING_SIDE*number_layers+init_pos_x, MagneticMap.WINDING_SIDE)
        return array
