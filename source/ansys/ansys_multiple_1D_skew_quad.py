...
class AnsysMultiple1DSkewQuad(AnsysMultiple1D, UnitConversion, Insulation):
    ...
    def calculate_total_winding_length(self):
        length_side1 = self.input_data.\
            geometry_settings.type_input.length_long_side * UnitConversion.milimeters_to_meters
        length_side2 = self.input_data.\
            geometry_settings.type_input.length_short_side * UnitConversion.milimeters_to_meters
        return 2.0 * (length_side1 + length_side2)

    def calculate_insulation_element_area(self):
        Insulation.check_input_of_correction_factor(self.input_data.geometry_settings.type_input.
                                                    strand_to_strand_contact_correction_factor)
        return Insulation.return_insulation_single_element_area(
            diameter_strand=self.input_data.geometry_settings.type_input.
                strand_diameter * UnitConversion.milimeters_to_meters,
            ...
            contact_correction_factor=self.input_data.geometry_settings.type_input.
                strand_to_strand_contact_correction_factor
        )
    ...
    def calculate_point_mass_volume(self):
        Insulation.check_input_of_correction_factor(self.input_data.geometry_settings.type_input.
                                                    strand_to_strand_contact_correction_factor)
        Insulation.check_input_of_correction_factor(self.input_data.geometry_settings.type_input.resin_filling_factor)
