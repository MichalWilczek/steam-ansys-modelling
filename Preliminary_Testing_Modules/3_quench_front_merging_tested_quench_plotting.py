...
for i in range(len(time)):
    ...
    if i == 0:
        ...
        quench_plots.append(plot.save_plot(plot.plot_quench(coil_length=coil_length,
        ...
        quench_plots.append(plot.save_plot(plot.plot_quench(coil_length=coil_length,
                                                            quench_fronts=quench_fronts), iteration=i))
plot.create_video(plot_array=quench_plots, filename='quench_propagation', extension='.gif')
