...
analysis_directory = "C:\\1_MIT_modelling\\ANSYS\\7_tested_project\\APDL"
...
ans.input_file(filename='Material_Properties_Superconducting', extension='inp', add_directory='input_files')
ans.input_file(filename='Geometry', extension='inp', add_directory='input_files')
...
ans.input_file(filename='Solve_Get_Temp', extension='inp', add_directory='input_files')
